    ...
    <div class="w-full space-y-12 animate-fade-in" style="animation-duration: 0.7s;">
      ...
      <div class="w-full space-y-6 text-left pt-6 border-t border-white/5">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 w-full">
          ...
          <div onclick="openCertModal('/public/certificado.png', 'Core Skills Test')" class="cursor-pointer bg-gray-900/40 border border-white/5 rounded-2xl p-5 relative overflow-hidden group transition hover:border-indigo-500/40 hover:scale-[1.02] duration-300">
          ...
          <div onclick="openCertModal('/public/wadwani.png', 'Job Ready: Habilidades para la empleabilidad')" class="cursor-pointer bg-gray-900/40 border border-white/5 rounded-2xl p-5 relative overflow-hidden group transition hover:border-purple-500/40 hover:scale-[1.02] duration-300">
          ...
          <div onclick="openCertModal('/public/huawey.jpg', 'HCIA-AI v3.5 COURSE INDONESIAN (HUAWEI TALENT ONLINE)')" class="cursor-pointer bg-gray-900/40 border border-white/5 rounded-2xl p-5 relative overflow-hidden group transition hover:border-indigo-500/40 hover:scale-[1.02] duration-300">
            <div class="absolute -top-10 -right-10 w-24 h-24 bg-indigo-500/5 rounded-full blur-2xl transition-all group-hover:bg-indigo-500/10"></div>
            <div class="flex justify-between items-start gap-4">
              <div class="space-y-1">
                <span class="text-[10px] font-mono tracking-wider uppercase text-indigo-400 bg-indigo-500/10 px-2 py-0.5 rounded">
